...
export default function Footer() {
  return (
    <footer
      className="border-gray-400 bg-neutral-900 flex w-full flex-col gap-4 border-t px-4 py-8 backdrop-blur-md
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <ul className="text-designit-gray flex h-4 gap-4 ">
        ...
        <Link
          className="text-designit-gray hover:text-white flex transition hover:underline"
      ...
      <div className="text-designit-gray flex max-w-xl flex-col gap-4">
        <p>
